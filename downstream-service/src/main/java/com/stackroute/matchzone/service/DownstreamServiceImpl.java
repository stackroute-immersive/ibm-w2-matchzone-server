...
import com.stackroute.matchzone.repository.AcademicDetailsRepository;
import com.stackroute.matchzone.repository.CertificationRepository;
import com.stackroute.matchzone.repository.LocationRepository;
import com.stackroute.matchzone.repository.PersonalInfoRepository;
import com.stackroute.matchzone.repository.ProjectRepository;
import com.stackroute.matchzone.repository.SkillsRepository;
...
public class DownstreamServiceImpl implements DownstreamService {
	...
	@Override
	public boolean createAcademicDetails(Academic academicDetails) {
	...
	public boolean deleteAcademicDetails(String id) {
		Academic academicDetails = academicDetailsRepository.findById(id).get();
	...
	@Override
	public Academic updateAcademicDetails(Academic academicDetails, String id) {
		Academic localAcademicDetails = academicDetailsRepository.findById(id).get();
	...
	@Override
	public Academic getAcademicDetails(String id) {
