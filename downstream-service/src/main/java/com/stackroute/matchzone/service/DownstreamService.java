...
public interface DownstreamService
{
	...
	// Academic Details
	boolean createAcademicDetails(Academic academicDetails);
	boolean deleteAcademicDetails(String id); // Doubt
	Academic updateAcademicDetails(Academic academicDetails, String id);
	Academic getAcademicDetails(String id);
