...
public class KafkaConfiguration {
	...
	// AcademicDetails
	@Bean
	public ConsumerFactory<String, Academic> academicDetailsConsumerFactory() {
		...
		return new DefaultKafkaConsumerFactory<>(config, new StringDeserializer(),
				new JsonDeserializer<>(Academic.class));
	}

	@Bean
	public ConcurrentKafkaListenerContainerFactory<String, Academic> kafkaListenerContainerFactory() {
